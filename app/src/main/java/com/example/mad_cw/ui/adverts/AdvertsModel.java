...
public class AdvertsModel implements Parcelable {
    ...
    private String ad_title, ad_price, ad_desc, ad_loc, ad_cond, ad_age, ad_owner;
    ...
    public AdvertsModel(String documentId, String ad_title, String ad_price, String ad_desc,
                        String ad_loc, String ad_cond, String ad_age, String ad_owner, Timestamp post_time, List<String> images) {
        this.documentId = documentId;
        this.ad_title = ad_title;
        this.ad_price = ad_price;
        this.ad_desc = ad_desc;
        this.ad_loc = ad_loc;
        this.ad_cond = ad_cond;
        this.ad_age = ad_age;
    ...
    public AdvertsModel(Parcel source) {
        ...
        this.ad_cond = source.readString();
    ...
    public String getAd_cond() { return ad_cond; }
    ...
    public void setAd_cond(String ad_cond) { this.ad_cond = ad_cond; }
